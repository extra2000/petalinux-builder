...
RUN apt update && apt install -y build-essential gawk xz-utils net-tools xterm autoconf libtool python3 less rsync texinfo zlib1g-dev gcc-multilib libncurses-dev zlib1g:i386 dos2unix expect bc tftpd
